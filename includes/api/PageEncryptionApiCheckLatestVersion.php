...
class PageEncryptionApiCheckLatestVersion extends ApiBase {
	...
	public function execute() {
		...
		$contents = file_get_contents( 'https://www.mediawiki.org/wiki/Extension:PageEncryption' );
		...
		$installedVersion = ExtensionRegistry::getInstance()->getAllThings()['PageEncryption']['version'];
	...
	protected function getExamplesMessages() {
		return [
			...
			=> 'apihelp-pageencryption-check-latest-version-example-1'
		];
	}
}
